...
# directory
####################################################################################################
RTCTMR_SRC_DIR := $(SYSLIB_SRC_DIR)/rtc_tmr
...
# add to syslib.mk
####################################################################################################
SRCS_SYSLIB_RAM   += $(SRCS_RTCTMR_RAM)
SRCS_SYSLIB_FLASH += $(SRCS_RTCTMR_FLASH)

SYSLIB_EXCLUDE_LIB_RAM   += $(RTCTMR_EXCLUDE_LIB_RAM)
SYSLIB_EXCLUDE_LIB_FLASH += $(RTCTMR_EXCLUDE_LIB_FLASH)

DEPS_PATH_SYSLIB += $(DEPS_PATH_RTCTMR)